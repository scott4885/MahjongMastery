...
## CHAPTER 1: WHAT AMERICAN MAHJONG IS (AND WHAT IT IS NOT)
...
### Three Things Make American Mahjong Unique:
...
## CHAPTER 3: TILE CATEGORIES (BEGINNER CHEAT SHEET)

Understanding tile terminology is essential for reading the card.

### Singles, Pairs, Pungs, and Kongs
...
## CHAPTER 4: THE NMJL CARD - HOW TO READ IT
...
**What this means:**
- DDDD = Four dragons (any dragon—you pick)
...
## CHAPTER 5: THE DEAL + STARTING THE GAME
...
3. Wall is 17 tiles long × 2 tiles high
...
## CHAPTER 9: CALLING TILES + EXPOSURES
...
1. **Mahjong** (wins the game—highest priority)
...
## CHAPTER 11: WINNING, MAHJONG, AND END OF HAND
...
- No gloating—everyone wins and loses

---

## CHAPTER 12: DALLAS MAHJONG / BLANKS VERSION (BEGINNER RULES)
...
- Multiple jokers in one turn (usually—check house rules)

### Beginner Safety Rules for Dallas Mahjong
...
### What Is Allowed vs. House Rules
...
## CHAPTER 13: BEGINNER STRATEGY THAT ACTUALLY WORKS
...
### 3 Beginner Hand Types to Target
...
- Flexible—can use dots, bams, or craks
...
## CHAPTER 14: BEGINNER HAND SELECTION

### After the Charleston, Ask:
...
## CHAPTER 16: JOKER DISCIPLINE (BEGINNER)

### Rule #1: Keep Jokers Through Charleston

Never pass jokers. Ever. They're gold.

### Rule #2: Use Jokers for Hard-to-Get Tiles
...
### Rule #3: Don't Expose Joker Melds Too Early
...
### How Many Jokers Is Good?

- **0 jokers:** Tough but doable
- **1-2 jokers:** Standard, use wisely
- **3+ jokers:** Powerful—lean into faster hands

---

## CHAPTER 17: DEFENSE FOR BEGINNERS

### The #1 Defensive Rule:
...
## CHAPTER 18: WHEN TO PIVOT VS. WHEN TO COMMIT
...
### Commit Triggers (Stick with Hand):
...
## CHAPTER 19: YOUR FIRST GAME CHECKLIST

### Before You Start:

- [ ] Set up tiles and walls correctly
- [ ] Each player has a card
- [ ] Confirm if playing with blanks/swapping
- [ ] Know who is East (dealer)

### During Charleston:

- [ ] Keep jokers
- [ ] Pass unusable tiles
- [ ] Stay calm (it's just passing!)

### During Play:

- [ ] Choose 1-2 possible hands
- [ ] Organize tiles by suit on rack
- [ ] Announce discards clearly
- [ ] Watch for dangerous players

### When Calling/Exposing:

- [ ] Make sure the tile helps
- [ ] Show the meld clearly
- [ ] Discard after calling

### Before Calling Mahjong:

- [ ] Double-check you have all tiles
- [ ] Verify it matches a card hand
- [ ] Count tiles (should be 14)

---

## CHAPTER 20: COMMON BEGINNER MISTAKES (AND THE FIX)

### Mistake #1: Passing Jokers in Charleston
**Fix:** NEVER pass jokers. Keep them always.

### Mistake #2: Choosing the "Pretty" Hand
**Fix:** Choose the hand your tiles support NOW.

### Mistake #3: Exposing Too Early
**Fix:** Only expose when you're close and confident.

### Mistake #4: Not Pivoting
**Fix:** If your hand isn't working after 10 turns, switch.

### Mistake #5: Feeding Wins
...
### Mistake #7: Holding Too Many Suits
...
## CHAPTER 21: QUICK REFERENCE PAGES
...
### "Can I Use a Joker Here?" Cheat Sheet
...
## CHAPTER 22: BONUS WORKSHEET - MY FIRST 5 GAMES TRACKER
...
Learn the SCAN-SHAPE-COMMIT-DEFEND framework that intermediate players use to win consistently—without relying on luck.
