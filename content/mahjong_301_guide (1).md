...
### You Are Not Playing Your Tiles
...
### You Are Playing Probability + People
...
## CHAPTER 1: OPPONENT PROFILING

### The 5 Player Archetypes
...
**How to exploit:**
- Read their exposures → guess their hand → block key tiles
- Let them expose first → stay concealed → finish while they're stuck
...
- Be patient—they rarely close efficiently
...
## CHAPTER 2: READING THE TABLE (ADVANCED)

### Exposure Patterns by Section Type
...
### Tile Temperature: Hot vs. Cold Tiles
...
**Identify forced hands early → hold key tiles → deny their win.**

---

## CHAPTER 3: RANGE-BASED THINKING

### Assigning 2-3 Likely Hands to Each Player
...
- Hand B: Dots + Winds
- Hand C: Unlikely—Bams are dead for them

**You've narrowed their hand to 2-3 possibilities.**

---

### Updating Ranges Every 3 Turns

**Ranges aren't static—update them constantly.**

**Turn 5:** Opponent likely on Winds or Dots
**Turn 9:** Opponent discarded all Dots → Now ONLY Winds + Craks
**Turn 12:** Opponent exposed SSSS (Souths) → Confirmed Winds section
...
### What "Impossible Hands" Look Like
...
## CHAPTER 4: DEFENSE THAT WINS GAMES

### The #1 Rule: Stop Donating Mahjongs
...
### When to Break Your Own Hand to Survive
...
## CHAPTER 5: BAITING + INFORMATION PLAYS
...
**If they call it:** They're on Bam runs → 5 Bam is DANGEROUS
...
- **Discards** reveal what you're not using
- **Calls** reveal what you need
- **Exposures** reveal your hand direction
...
### Creating False Trails (Without Being Reckless)
...
## CHAPTER 6: BLOCK STRATEGY

### Identifying the Key Tile(s) to Withhold
...
### How to Block Without Destroying Your Win Path
...
**Don't sacrifice your win to block—only block with tiles you don't need.**

---

## CHAPTER 7: TEMPO CONTROL

### Speeding Up vs. Slowing Down the Game
...
**Behind?** → Speed up (expose early, force action)

**Ahead?** → Slow down (stay concealed, finish quietly)

---

### Winning by Forcing Mistakes
...
## CHAPTER 8: HIGH-UPSIDE LINES (PLAYING FROM BEHIND)

### When to Chase Big Hands
...
## CHAPTER 9: ENDGAME WARFARE

### 8-Tiles-Left Decision System

**With 8 tiles left in the wall, evaluate:**

1. **Can I finish before tiles run out?**
   - If yes → Push aggressively
   - If no → Defensive mode

2. **How close are opponents?**
   - Multiple opponents exposed → High danger
   - All concealed → Moderate danger

3. **What tiles are left?**
   - Critical tiles still in wall → Keep going
   - Critical tiles already gone → Pivot or defend

**Make the call by turn 18-20 (roughly 8 tiles left).**

---

### What to Discard When Everyone Is Dangerous
...
### How to Win When You're Exposed and Close
...
## CHAPTER 10: JOKER WARFARE

### Joker Swap Traps (Dallas Mahjong)
...
4. Opponent thinks they got a joker → BUT you never needed it
...
### Protecting Joker-Dependent Hands
...
2. **Use real tiles for exposures**
   - Expose real-tile pungs first
   - Hide joker melds

3. **Finish quickly after exposing jokers**
   - 1-2 turns max before they can swap

---

### How to Read Who Is Holding Jokers
...
## CHAPTER 11: DALLAS MAHJONG / BLANKS ADVANCED ADD-ON

### Blank-Driven Threat Modeling
...
### Swapping Strategy and Counter-Strategy
...
2. **Don't rely on "they can't finish without jokers"**
   - They might swap one next turn

3. **Play slightly more aggressive**
...
## CHAPTER 12: ADVANCED RULES OF THUMB (50+)
...
### Charleston
6. Your Charleston passes should create ambiguity, not clarity (for opponents)
7. Mix suit passes to avoid telegraphing
8. Watch who's passing what (signals their direction)
9. If someone passes back exactly what you gave them, they're not using that suit
10. Coordinate with competent partners in team play (if applicable)

### Exposures
11. First exposure = information leak; second exposure = partial reveal; third exposure = transparency
12. Expose when concealment no longer provides value
13. Don't expose if it invites blocking
14. Expose rare tiles, hold common tiles
15. Concealed hands win more, exposed hands win faster (choose based on table tempo)

### Jokers
16. Jokers in concealed hands = max flexibility
17. Jokers in exposed hands = swap targets
18. Never expose joker melds when 5+ tiles from Mahjong
19. Use jokers for least-available tiles
20. With 5+ jokers, play the fastest hand possible

### Table Reading
21. First discard tells you least; tenth discard tells you most
22. Watch reaction times (hesitation = consideration)
23. Confident discards often signal safe tiles
24. Nervous discards often signal "I hope this is okay"
25. Silence (no calls) often means strong concealed hands or dead hands

### Defense
26. When two opponents are close, block the closer one
27. Feed the player in last place before feeding the leader
28. If you must feed someone, feed the player least likely to win again (balance table)
29. Breaking your hand to avoid feeding is often correct
30. Defensive play costs you wins but saves you points—net positive

### Timing & Tempo
31. Control tempo by controlling exposure pace
32. Speed up when behind, slow down when ahead
33. Force action when you're strong, delay when you're weak
34. Wall games favor patient players
35. Rushed games favor aggressive players

### Opponent Exploitation
36. Exploit Early Exposers by reading and blocking
37. Exploit Joker Hunters by denying swap opportunities
38. Exploit Card Chasers by letting them chase impossible hands
39. Respect Silent Killers (play cautiously)
40. Ignore Chaos Passers (they self-destruct)

### Blocking
41. Block only if it doesn't hurt you
42. Block when opponent is 1-2 tiles away
43. Block key tiles, not marginal tiles
44. If you can't block, finish first
45. Blocking is revenge for past losses (don't let emotion drive it)

### Endgame
46. With 6 tiles left, evaluate: Can I finish? If no, defend fully
47. Late-game pivots rarely work (commit earlier)
48. Desperate situations call for desperate hands
49. When everyone's close, the first to blink loses
50. The last tile drawn is the most dangerous to discard (everyone's waiting)

---

## CHAPTER 13: THE DRILL PACK (20 SCENARIOS)

### Scenario 1: Push or Defend?
**Situation:**
...
**Answer:** PIVOT (if a viable alternative exists) or DEFEND (if no alternatives). You're too far behind with 6 tiles needed. Commit to defense—don't feed wins.

---

### Scenario 4: What Tile Is Most Dangerous?
**Opponent exposed:**
- **3-4-5 Bams** (run)
- **7-7-7 Dots** (pung)
...
### Scenario 5: What Hand Is She On?
**Opponent Charleston:**
- Passed all Craks
- Kept Bams and Dots
...
### Scenario 10: Defensive Sacrifice
...
### Scenario 11: Tempo Manipulation
...
**Answer:** **Stay concealed.** You're ahead—no need to force action. Let opponents struggle quietly. Exposing speeds the game up and invites defensive pressure. **Slow tempo favors the leader.**

---

### Scenario 12: Baiting Info
**You think Opponent A might need 6 Dots.**

**Question:** How do you test this without throwing 6 Dots?

**Answer:** Discard **5 Dots or 7 Dots** (adjacent tiles). If they call it, they're on Dot runs → 6 Dots is DANGEROUS. If they pass, 6 Dots might be safer. **Bait with adjacent tiles to test.**

---

### Scenario 13: Range Assignment
**Opponent exposed:**
- **EEEE** (Four Easts)
- **WWWW** (Four Wests)
...
**Answer:** **Hand B (high-upside).** You're behind—playing safe means second/third place. Take the risk. If Hand B hits, you win big and catch up. If it fails, you weren't winning anyway. **Play aggressive from behind.**

---

### Scenario 17: False Trail
**Your real hand:** Dots + Red Dragons
**You discarded:** 3 Bams, 2 Craks, 1 Bam

**Question:** What false trail are you creating?

**Answer:** You're suggesting you might be on Bams or Craks. Opponents might think you're NOT on Dots. This buys you time—they might discard Dots thinking you don't need them. **Effective misdirection.**

---

### Scenario 18: Joker Protection
**Your hand (concealed):**
- 4-4-Joker Bams
- 6-6-Joker Craks
...
### Scenario 19: Opponent Tell
**Opponent hesitated for 5 seconds before discarding 7 Crak.**

**Question:** What does this tell you?

**Answer:** **Hesitation = consideration.** They thought about keeping it, meaning 7 Crak (or Craks in general) might be valuable to them. It's now a WARM tile—somewhat dangerous. **Watch for Crak-related hands.**

---

### Scenario 20: Meta-Game Adjustment
**Table composition:**
...
**Scoring Guide:**
- **85-100 points:** Advanced mastery—you're a top-tier player
- **70-84 points:** Strong advanced skills—keep refining
...
## CHAPTER 16: ADVANCED MISTAKES TO AVOID

### Mistake #1: Over-Profiling
...
## BONUS: THE ADVANCED MINDSET CHECKLIST

**Before Every Game, Ask:**
- [ ] Who are my opponents? (Archetypes)
- [ ] What's the table tempo? (Aggressive vs. passive)
- [ ] What's my game plan? (Offense vs. defense-heavy)

**During Every Game, Track:**
- [ ] Opponent ranges (update every 3 turns)
- [ ] Tile availability (hot vs. cold)
- [ ] Danger levels (who's close?)
- [ ] Blocking opportunities (key tiles to hold)
...
### RANGE-BAIT-BLOCK-CLOSE Framework
...
### Opponent Archetype Quick Guide
...
- [ ] Does holding this tile hurt my hand? (If yes, don't block)
- [ ] Is opponent 1-2 tiles from winning? (If no, blocking less critical)
- [ ] Is this a KEY tile for them? (If yes, hold it)
- [ ] Can I finish first instead? (If yes, finish > block)
