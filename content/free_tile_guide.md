...
Congratulations on starting your American Mahjong journey! Choosing your first tile set can feel overwhelming—there are dozens of options, confusing terminology, and prices ranging from $40 to $400+.
...
## CHAPTER 1: THE 3 TYPES OF MAHJONG SETS
...
## CHAPTER 2: TILE MATERIALS (WHAT FEELS PREMIUM VS. WHAT CHIPS)
...
### Resin/Premium Materials (Luxury)
**Price range:** $150-$400+
...
### Standard Size
**Tile dimensions:** Approximately 1.25" tall × 0.75" wide
...
### Large/Oversized Tiles
**Tile dimensions:** Approximately 1.5" tall × 1" wide
...
## CHAPTER 4: NUMBERS, COLORS, AND CLARITY

### High Contrast vs. Decorative
...
**Dragons:**
- Red Dragon: 紅 or solid red
- Green Dragon: 發 or solid green
...
## CHAPTER 6: CARRYING CASE & STORAGE

### Essential Case Features:
...
## CHAPTER 7: WHAT TO LOOK FOR WHEN BUYING USED

Buying used can save you 40-60%, but you need to check carefully.

### Missing Tiles Checklist

**Count everything:**
- 36 dots (9 numbers × 4 of each)
- 36 bams (9 numbers × 4 of each)
- 36 craks (9 numbers × 4 of each)
...
4. Flip them over—printing should be crisp and clear
5. Stack them—they should sit flat and stable
...
## CHAPTER 9: MY RECOMMENDED STARTER SETUP

### For Most Beginners: The "Sweet Spot" Setup
...
### Budget-Conscious Alternative ($60-$80)
...
### Premium Option (If Budget Allows: $180-$250)
...
## CHAPTER 10: QUICK BUYER CHECKLIST

### Before You Buy, Confirm:

**Tile Count:**
- [ ] 166 tiles total (or 152 minimum + jokers)
- [ ] Specifically for American Mahjong/NMJL

**Materials:**
- [ ] Acrylic (recommended) or melamine (budget)
- [ ] High-contrast, clear printing
- [ ] Tiles feel smooth and uniform

**Accessories:**
- [ ] 4 racks (angled preferred)
- [ ] 2-4 dice
- [ ] Carrying case
- [ ] Pushers (helpful but optional)

**Readability:**
- [ ] Numbers are large and clear
- [ ] Suits are easily distinguishable
- [ ] Can read from 2-3 feet away

**Quality Check (if buying used):**
- [ ] All tiles accounted for
- [ ] No chips, cracks, or yellowing
- [ ] Racks are stable
- [ ] Case latches work

**Price Check:**
- [ ] Within budget
- [ ] Comparable to similar sets
...
You now know exactly what to look for in your first mahjong set. Don't overthink it—the best set is one you'll actually use and enjoy playing with.
...
## BONUS: TILE SET COMPARISON CHART
...
## QUICK REFERENCE: TILE BREAKDOWN
